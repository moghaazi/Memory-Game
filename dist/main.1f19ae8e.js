...
var disableImg = function disableImg() {
...
var unflipImg = function unflipImg() {
  lockImg = true;
  setTimeout(function () {
...
(function shuffleImgs() {
  imgs.forEach(function (img) {
    var randomImgs = Math.floor(Math.random() * 20);
    img.style.order = randomImgs;
  });
})();

imgs.forEach(function (img) {
  return img.addEventListener("click", showImg);
});
